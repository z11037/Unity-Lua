...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp0(Character p0, int p1)
		{
		...
		public void __Gen_Delegate_Imp1(Character p0, Character p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(BuffApply))
			{
			    return new BuffApply(__Gen_Delegate_Imp0);
			}
		
		    if (type == typeof(BuffRemove))
			{
			    return new BuffRemove(__Gen_Delegate_Imp0);
			}
		
		    if (type == typeof(BuffTick))
			{
			    return new BuffTick(__Gen_Delegate_Imp0);
			}
		
		    if (type == typeof(SkillExecute))
			{
			    return new SkillExecute(__Gen_Delegate_Imp1);
			}
